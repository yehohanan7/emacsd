...
(setq yas-snippet-dirs (append yas-snippet-dirs '("~/.emacsd/snippets")))
...
(use-package ensime
   :ensure ensime
   :bind 
   (("C-S-t" . ensime-goto-test)
    ("C-S-i" . ensime-goto-impl)))

(add-hook 'scala-mode-hook '(lambda ()
  (yas-minor-mode)
  (local-set-key (kbd "<backtab>") 'yas-expand)))
...
(add-hook 'before-save-hook 'gofmt-mode-setup)
